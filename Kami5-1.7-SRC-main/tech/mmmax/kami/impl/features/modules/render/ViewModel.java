...
extends Module {
    ...
    Value<Boolean> aspect = new ValueBuilder().withDescriptor("Aspect").withValue(false).withAction(set -> this.aspectAmount.setActive((Boolean)set.getValue())).register(this);

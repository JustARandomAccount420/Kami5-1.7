...
extends Module {
    ...
    Value<String> fillColorMode = new ValueBuilder().withDescriptor("Fill Mode").withValue("Normal").withModes("Normal", "Custom").withAction(set -> {
    ...
    Value<String> outlineColorMode = new ValueBuilder().withDescriptor("Outline Mode").withValue("Normal").withModes("Normal", "Custom", "None").withAction(set -> this.outlineValue.setActive(((String)set.getValue()).equals("Custom"))).register(this);
    ...
    Value<String> mode = new ValueBuilder().withDescriptor("Mode").withValue("Distance").withModes("Distance", "Close", "Dynamic").withAction(set -> this.dist.setActive(((String)set.getValue()).equals("Distance"))).register(this);

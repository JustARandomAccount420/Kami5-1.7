...
extends Module {
    ...
    Value<Number> delay = new ValueBuilder().withDescriptor("Delay").withValue(200).withRange(0, 2000).withAction(set -> this.timer.setDelay(((Number)set.getValue()).longValue())).register(this);

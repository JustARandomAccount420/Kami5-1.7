...
extends Module {
    ...
    Value<Number> delay = new ValueBuilder().withDescriptor("Delay").withValue(200).withRange(20, 2000).withAction(set -> this.breakTimer.setDelay(((Number)set.getValue()).longValue())).register(this);
    ...
    Value<Boolean> autoBreak = new ValueBuilder().withDescriptor("AutoBreak").withValue(false).withAction(set -> {
        this.delay.setActive((Boolean)set.getValue());
        this.autoBreakGhostSwitch.setActive((Boolean)set.getValue());
    }).register(this);
    ...
    Value<String> mode = new ValueBuilder().withDescriptor("Mode").withValue("Packet").withModes("Packet", "Instant", "InstantBypass").withAction(set -> {
    ...
    public void onUpdate(TickEvent.ClientTickEvent event) {
        ...
        if (this.breaking != null) {
            ...
            if (this.switchTimer.isPassed()) {
                if (this.ghostSwitch.getValue().booleanValue()) {
                    int pickSlot = -1;

...
IMetrics {
    ...
    Value<Boolean> rainbow = new ValueBuilder().withDescriptor("Rainbow").withValue(false).withAction(val -> {
        this.rainbowSat.setActive((Boolean)val.getValue());
        this.rainbowBri.setActive((Boolean)val.getValue());
    }).register(this);

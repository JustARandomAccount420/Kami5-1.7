...
extends Module {
    ...
    Value<Number> forceDelay = new ValueBuilder().withDescriptor("Force Delay").withValue(1).withRange(1, 1000).withAction(s -> this.forceTimer.setDelay(((Number)s.getValue()).longValue())).register(this);
    Value<Number> jumpDelay = new ValueBuilder().withDescriptor("Jump Delay").withValue(1).withRange(1, 1000).withAction(s -> this.jumpTimer.setDelay(((Number)s.getValue()).longValue())).register(this);

...
public class Strafe
extends Module {
    Value<Number> airSpeed = new ValueBuilder().withDescriptor("Air Speed").withValue(1.2).withRange((Double)1, 1.3).register(this);
    Value<Number> downSpeed = new ValueBuilder().withDescriptor("Down Speed").withValue(1.2).withRange((Double)1, 1.3).register(this);
    Value<Number> groundSpeed = new ValueBuilder().withDescriptor("Ground Speed").withValue(1.2).withRange((Double)1, 1.3).register(this);
    Value<Number> jumpSpeed = new ValueBuilder().withDescriptor("Jump Speed").withValue(1.2).withRange((Double)1, 1.3).register(this);
    Value<Boolean> useTimer = new ValueBuilder().withDescriptor("Use Timer").withValue(false).register(this);
    Value<Number> timerAmount = new ValueBuilder().withDescriptor("Timer Amount").withValue(1.2).withRange((Double)1, 1.3).register(this);
    float oldTickLength;
    ITimer timer;

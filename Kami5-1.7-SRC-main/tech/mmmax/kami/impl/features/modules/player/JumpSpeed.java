...
extends Module {
    ...
    Value<Number> delay = new ValueBuilder().withDescriptor("Delay").withValue(50).withRange(1, 1000).withAction(val -> this.timer.setDelay(((Number)val.getValue()).longValue())).register(this);

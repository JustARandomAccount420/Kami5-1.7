...
extends Module {
    ...
    Value<Number> delay = new ValueBuilder().withDescriptor("Delay").withValue(3).withRange(0, 200).withAction(s -> this.timeSystem.setDelay(((Number)s.getValue()).longValue())).register(this);
    Value<Number> triggerDelay = new ValueBuilder().withDescriptor("Trigger Delay").withValue(3).withRange(1, 2000).withAction(s -> this.disableTimer.setDelay(((Number)s.getValue()).longValue())).register(this);

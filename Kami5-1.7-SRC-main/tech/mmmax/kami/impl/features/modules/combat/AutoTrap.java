...
extends Module {
    ...
    Value<Number> delay = new ValueBuilder().withDescriptor("Delay").withValue(0).withRange(0, 1000).withAction(set -> this.timer.setDelay(((Number)set.getValue()).intValue())).register(this);
